...
const query = "SELECT transaksi.*, users.name as user, products.name as product FROM transaksi INNER JOIN users ON transaksi.id_user=users.id INNER JOIN products ON transaksi.id_product=products.id"
